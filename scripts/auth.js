...
registerForm?.addEventListener('submit', async (e)=>{
  ...
  try{
    ...
    alert("Registrado correctamente! Revisa tu correo para verificar la cuenta.");
...
// Logout
logoutBtn?.addEventListener('click', async ()=>{ await signOut(auth); alert("Sesión cerrada"); });
