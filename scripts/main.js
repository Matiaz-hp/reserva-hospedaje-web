...
const hotelesList = document.getElementById('hoteles-grid') || document.querySelector('.hoteles-grid');
...
async function cargarHoteles(filtro='') {
  ...
  snapshot.forEach(docSnap=>{
    ...
    // Usando imagen de Unsplash por ciudad
    ...
    // Cargar clima con OpenWeatherMap
    if(h.lat && h.lng){
